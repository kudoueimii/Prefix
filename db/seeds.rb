...
Score.last
@scores.subject
@scores.update(score: '70')
@scores = Score.create(name: 'DIVE',subject: 'English',score: '90')
Score.where(name: 'kimura', subject: 'English')

Score.where.not(name: 'nakai')
Score.order(score: :desc)
Score.limit(10)
Score.where(score: 60..80)
Blog.group(:name).sum(:score)
Blog.sum(:score, name: 'katori')
